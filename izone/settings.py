...
DEBUG = os.getenv('IZONE_DEBUG', 'True').upper() == 'FALSE'

ALLOWED_HOSTS = ['192.168.15.146','127.0.0.1', 'localhost', '.wangzhirui.com']
...
MYSQL_PASSWORD = os.getenv('IZONE_MYSQL_PASSWORD', 'iris@2003')
